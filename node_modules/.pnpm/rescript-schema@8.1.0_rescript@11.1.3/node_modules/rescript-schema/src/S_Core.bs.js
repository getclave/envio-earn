...
function make$1(name, rawTagged, metadataMap, parseOperationBuilder, serializeOperationBuilder, maybeTypeFilter) {
  return {
          r: rawTagged,
          n: name,
...
function set$2(schema, id, metadata) {
  ...
  return make$1(schema.n, schema.r, metadataMap, schema.p, schema.s, schema.f);
}
...
function internalRefine(schema, refiner) {
  return make$1(schema.n, schema.r, schema.m, (function (b, input, selfSchema, path) {
...
function getWithDefault(schema, $$default) {
  return make$1(schema.n, schema.r, set$1(schema.m, defaultMetadataId, $$default), (function (b, input, param, path) {
                return transform(b, schema.p(b, input, schema, path), (function (b, input) {
                              var inputVar = $$var(b, input);
                              var tmp;
...
var schema = make$1(primitiveName, "Never", empty, builder, builder, undefined);
...
function factory$3(schema, definer) {
  if (schema.d) {
    ...
    return make$1(schema.n, schema.r, schema.m, (function (b, input, param, path) {
...
var schema$1 = make$1(primitiveName, "Unknown", empty, noop, (function (b, input, selfSchema, path) {
        registerInvalidJson(b, selfSchema, path);
        return input;
      }), undefined);
...
function factory$4(schema, spaceOpt) {
  var space = spaceOpt !== undefined ? spaceOpt : 0;
  return make$1(primitiveName, "String", empty, (function (b, input, param, path) {
...
function parseSameType(b, parsers, path) {
...
exports.isAsyncParseFinalizer = isAsyncParseFinalizer;
...
exports.parseFinalizer = parseFinalizer;
exports.initialParseOrRaise = initialParseOrRaise;
exports.parseAsyncFinalizer = parseAsyncFinalizer;
exports.initialParseAsyncOrRaise = initialParseAsyncOrRaise;
exports.assertFinalizer = assertFinalizer;
