...
@genType
and entities = {
    @as("AccountClaggPosition") accountClaggPosition: entityStoreOperations<Entities.AccountClaggPosition.t>,
    @as("AccountIdleBalance") accountIdleBalance: entityStoreOperations<Entities.AccountIdleBalance.t>,
    @as("AccountSyncswapPosition") accountSyncswapPosition: entityStoreOperations<Entities.AccountSyncswapPosition.t>,
    @as("AccountVenusPosition") accountVenusPosition: entityStoreOperations<Entities.AccountVenusPosition.t>,
    @as("ClaggAdapter") claggAdapter: entityStoreOperations<Entities.ClaggAdapter.t>,
    @as("ClaggPool") claggPool: entityStoreOperations<Entities.ClaggPool.t>,
    @as("HistoricalAccountIdleBalance") historicalAccountIdleBalance: entityStoreOperations<Entities.HistoricalAccountIdleBalance.t>,
    @as("SyncswapPool") syncswapPool: entityStoreOperations<Entities.SyncswapPool.t>,
    @as("Token") token: entityStoreOperations<Entities.Token.t>,
    @as("VenusPool") venusPool: entityStoreOperations<Entities.VenusPool.t>,
  }
  ...
  let entities = {
      accountClaggPosition: {
        makeStoreOperatorEntity(
          ~inMemoryStore,
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db.entities->InMemoryStore.EntityTables.get(module(Entities.AccountClaggPosition)),
          ~getKey=({id}) => id,
        )
      },
      accountIdleBalance: {
        makeStoreOperatorEntity(
          ~inMemoryStore,
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db.entities->InMemoryStore.EntityTables.get(module(Entities.AccountIdleBalance)),
          ~getKey=({id}) => id,
        )
      },
      accountSyncswapPosition: {
        makeStoreOperatorEntity(
          ~inMemoryStore,
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db.entities->InMemoryStore.EntityTables.get(module(Entities.AccountSyncswapPosition)),
          ~getKey=({id}) => id,
        )
      },
      accountVenusPosition: {
        makeStoreOperatorEntity(
          ~inMemoryStore,
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db.entities->InMemoryStore.EntityTables.get(module(Entities.AccountVenusPosition)),
          ~getKey=({id}) => id,
        )
      },
      claggAdapter: {
        makeStoreOperatorEntity(
          ~inMemoryStore,
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db.entities->InMemoryStore.EntityTables.get(module(Entities.ClaggAdapter)),
          ~getKey=({id}) => id,
        )
      },
      claggPool: {
        makeStoreOperatorEntity(
          ~inMemoryStore,
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db.entities->InMemoryStore.EntityTables.get(module(Entities.ClaggPool)),
          ~getKey=({id}) => id,
        )
      },
      historicalAccountIdleBalance: {
        makeStoreOperatorEntity(
          ~inMemoryStore,
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db.entities->InMemoryStore.EntityTables.get(module(Entities.HistoricalAccountIdleBalance)),
          ~getKey=({id}) => id,
        )
      },
      syncswapPool: {
        makeStoreOperatorEntity(
          ~inMemoryStore,
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db.entities->InMemoryStore.EntityTables.get(module(Entities.SyncswapPool)),
          ~getKey=({id}) => id,
        )
      },
      token: {
      ...
      venusPool: {
        makeStoreOperatorEntity(
          ~inMemoryStore,
          ~makeMockDb=makeWithInMemoryStore,
          ~getStore=db => db.entities->InMemoryStore.EntityTables.get(module(Entities.VenusPool)),
          ~getKey=({id}) => id,
        )
      },
  }
