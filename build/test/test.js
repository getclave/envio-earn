...
const { MockDb, ERC20, Addresses } = generated_1.TestHelpers;
describe("Transfers", () => {
    it("Transfer subtracts the from account balance and adds to the to account balance", async () => {
        ...
        assert_1.default.equal(2n, account1Balance, "Should have subtracted transfer amount 3 from userAddress1 balance 5");
        ...
        //Assert the expected balance
        assert_1.default.equal(3n, account2Balance, "Should have added transfer amount 3 to userAddress2 balance 0");
    });
});
